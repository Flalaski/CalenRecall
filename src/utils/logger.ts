/**
 * Centralized logging utility for React renderer process.
...
const DEBUG_ENABLED = import.meta.env.VITE_DEBUG === 'true' || isDev;
...
export const logger = {
  ...
  /**
   * Log a debug message
   * Only logged in development or when VITE_DEBUG=true
   * 
