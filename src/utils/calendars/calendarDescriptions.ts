...
export const CALENDAR_DESCRIPTIONS: Record<CalendarSystem, CalendarDescription> = {
  gregorian: {
    ...
    history: 'The Gregorian calendar was introduced to correct the drift of the Julian calendar, which had accumulated about 10 days of error since its introduction. Pope Gregory XIII decreed that after October 4, 1582 (Thursday), ten days would be dropped, making the next day October 15, 1582 (Friday). The beginning of the year was also changed back from March 25 to January 1 (as it had been in the original Julian calendar). The reform adjusted the leap year rule: a year is a leap year if it is divisible by 4 but not by 100, or if it is divisible by 400. The calendar was adopted at different times by different countries: Italy, Poland, Portugal, and Spain in 1582; Great Britain (including what is now the USA) in 1752 (skipping 11 days from September 2 to September 14); Russia in 1918 (skipping 13 days from January 31 to February 14); and Turkey in 1927.',
    notes: 'The calendar uses a 400-year cycle with 97 leap years. Century years are only leap years if divisible by 400. The month lengths are the same as the Julian calendar after Augustus\'s reforms: January 31, February 28/29, March 31, April 30, May 31, June 30, July 31, August 31, September 30, October 31, November 30, December 31.'
  },
  julian: {
    ...
    history: 'The Julian calendar was implemented in 45 BCE following consultation with the Alexandrian astronomer Sosigenes. The year 46 BCE is known as the "year of confusion" (annus confusionis) because it contained 445 days due to two intercalations: one to correct the spring equinox and another to transition from the lunisolar calendar to a purely solar calendar. Emperor Augustus reformed the calendar in 8 CE, adjusting month lengths (notably renaming Quintilis to Julius/July and Sextilis to Augustus/August, and adjusting their lengths). Due to errors by priests, leap years were incorrectly applied every three years instead of four from 9 BCE to 8 CE, requiring correction. The calendar remained in use throughout the Roman Empire and was adopted by the Christian church. Many Eastern Orthodox churches still use the Julian calendar for calculating Easter and other religious holidays.',
    notes: 'The Julian calendar has a simpler leap year rule than the Gregorian: every year divisible by 4 is a leap year. This causes it to drift about one day every 128 years relative to the solar year. The calendar uses the modern month structure established by Augustus in 8 CE, with month lengths matching the Gregorian calendar (January 31, February 28/29, March 31, April 30, May 31, June 30, July 31, August 31, September 30, October 31, November 30, December 31).'
  },
  islamic: {
    ...
    history: 'The Islamic calendar (Hijri calendar) began in 622 CE when the Prophet Muhammad migrated from Mecca to Medina (the Hijra). Like other ancient lunar calendars, months were traditionally determined by the first sighting of the new crescent moon. If clouds obscured vision on the 29th day, that month was declared to have 30 days—a practice that is still observed today. The calendar is used for religious purposes throughout the Islamic world. While actual lunar observations are preferred, mathematical calculations are also used.',
    notes: 'Because the Islamic year is about 11 days shorter than the solar year, Islamic dates shift earlier each year relative to the Gregorian calendar. The calendar uses a 30-year cycle with 11 leap years. Months alternate between 29 and 30 days, with adjustments in leap years.'
  },
  hebrew: {
    ...
    history: 'The Hebrew calendar was promulgated by the Patriarch Hillel II in the mid-fourth century CE. The calendar has ancient origins, with its current form developing over centuries. The era (Anno Mundi, "Year of the World") is calculated from the traditional date of creation, 3761 BCE. The calendar uses a 19-year Metonic cycle (originally calculated by the Greek astronomer Meton in 432 BCE) to synchronize lunar and solar cycles, adding an extra month (Adar II) in 7 out of every 19 years. Leap years occur in the 3rd, 6th, 8th, 11th, 14th, 17th, and 19th years of the cycle. Common years have 353-355 days, while leap years have 383-385 days.',
    notes: 'The Hebrew calendar determines the start of months based on the new moon (conjunction), and years can have 12 or 13 months. The beginning of the Hebrew new year (Rosh Hashanah) is determined by the occurrence of the new moon of the seventh month (Tishrei), subject to possible postponement rules. The calendar is used to determine Jewish holidays and religious observances.'
  },
  persian: {
  ...
  chinese: {
    ...
    history: 'The Chinese calendar has been in use for over 3,000 years, with its origins in the Shang Dynasty (14th century BCE). The calendar uses a 60-year sexagenary cycle (干支纪年) combining 10 heavenly stems and 12 earthly branches, with each year receiving a unique name from this cycle. Months begin on the day of the new moon, and years contain 12 or 13 such months, with the number of months determined by the number of new moons between successive winter solstices. Intercalary months (闰月, rùnyuè) are added approximately every 2-3 years to keep the calendar aligned with seasons. There have been more than 50 calendar reforms since its inception. The 24 solar terms (二十四节气) divide the year based on the sun\'s position and guide agricultural activities.',
