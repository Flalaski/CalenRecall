...
exports.playMechanicalClick = playMechanicalClick;
exports.playMicroBlip = playMicroBlip;
exports.playNavigationSound = playNavigationSound;
exports.playModeSelectionSound = playModeSelectionSound;
exports.playSaveSound = playSaveSound;
exports.playCancelSound = playCancelSound;
exports.playDeleteSound = playDeleteSound;
exports.playEditSound = playEditSound;
exports.playNewEntrySound = playNewEntrySound;
exports.playAddSound = playAddSound;
exports.playRemoveSound = playRemoveSound;
exports.playSettingsSound = playSettingsSound;
exports.playResetSound = playResetSound;
exports.playExportSound = playExportSound;
exports.playCalendarSelectionSound = playCalendarSelectionSound;
exports.playEntrySelectionSound = playEntrySelectionSound;
...
function playMechanicalClick(direction) {
...
function playModeSelectionSound() {
    const audioContext = getAudioContext();
    if (!audioContext)
        return;
    if (audioContext.state === 'closed')
...
function playCalendarSelectionSound() {
    const audioContext = getAudioContext();
    if (!audioContext)
        return;
    if (audioContext.state === 'closed')
...
function playEntrySelectionSound() {
    const audioContext = getAudioContext();
    if (!audioContext)
        return;
    if (audioContext.state === 'closed')
