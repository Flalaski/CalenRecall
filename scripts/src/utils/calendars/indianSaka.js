...
exports.indianSakaCalendar = void 0;
exports.isSakaLeapYear = isSakaLeapYear;
exports.getDaysInSakaYear = getDaysInSakaYear;
exports.getDaysInSakaMonth = getDaysInSakaMonth;
exports.sakaToJDN = sakaToJDN;
exports.jdnToSaka = jdnToSaka;
 ...
 */
function getDaysInSakaYear(year) {
    return isSakaLeapYear(year) ? 366 : 365;
}
/**
 * Get number of days in a Saka month
 */
function getDaysInSakaMonth(year, month) {
    const monthLengths = [
        31, // Chaitra
        31, // Vaisakha
        31, // Jyeshtha
...
exports.indianSakaCalendar = {
    ...
    getInfo() {
        return types_1.CALENDAR_INFO['indian-saka'];
    },
