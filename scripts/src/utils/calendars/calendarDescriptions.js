...
exports.CALENDAR_DESCRIPTIONS = void 0;
exports.CALENDAR_DESCRIPTIONS = {
    gregorian: {
    ...
    chinese: {
        definition: 'A lunisolar calendar system used in China and other East Asian countries for traditional festivals and cultural events. It combines lunar months with solar terms.',
        history: 'The Chinese calendar has been in use for over 3,000 years, with its origins in the Shang Dynasty. The calendar uses a 60-year cycle combining 10 heavenly stems and 12 earthly branches. It determines months by lunar phases and years by solar terms, with intercalary months added to keep the calendar aligned with seasons.',
        notes: 'The Chinese calendar is still used alongside the Gregorian calendar in China for traditional holidays like Chinese New Year. Each year is associated with one of 12 zodiac animals in a repeating cycle.'
    },
    ethiopian: {
