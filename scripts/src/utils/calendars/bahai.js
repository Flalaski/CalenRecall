...
function getNawRuzJDN(bahaiYear) {
    ...
    return (0, julianDayUtils_1.gregorianToJDN)(gregorianYear, 3, 21);
}
/**
 * Check if a Baháʼí year has 5 intercalary days (leap year)
 * This follows the same pattern as Gregorian leap years
 */
function isBahaiLeapYear(bahaiYear) {
    const gregorianYear = 1844 + bahaiYear - 1;
    return (0, julianDayUtils_1.isGregorianLeapYear)(gregorianYear);
}
exports.bahaiCalendar = {
    ...
    getInfo() {
        return types_1.CALENDAR_INFO.bahai;
    },
