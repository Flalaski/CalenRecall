...
exports.getCalendarEpoch = getCalendarEpoch;
exports.isValidCalendarYear = isValidCalendarYear;
exports.getEraForYear = getEraForYear;
exports.formatYearWithEra = formatYearWithEra;
 ...
 */
function getCalendarEpoch(calendar) {
    const eraStart = types_1.CALENDAR_INFO[calendar].eraStart;
    switch (calendar) {
        case 'gregorian':
            // Gregorian year 1, January 1 = JDN 1721424
            return (0, julianDayUtils_1.gregorianToJDN)(1, 1, 1);
        case 'julian':
            // Julian year 1, January 1 = JDN 1721424 (same as Gregorian for year 1)
            return (0, julianDayUtils_1.julianToJDN)(1, 1, 1);
        case 'islamic':
        ...
        case 'chinese':
            ...
            return (0, julianDayUtils_1.gregorianToJDN)(1900, 2, 5); // Approximate
        case 'ethiopian':
        ...
        case 'thai-buddhist':
            ...
            return (0, julianDayUtils_1.gregorianToJDN)(-543, 1, 1);
        case 'mayan-tzolkin':
        case 'mayan-haab':
 ...
 */
function isValidCalendarYear(calendar, year) {
 ...
 */
function getEraForYear(calendar, year) {
    const info = types_1.CALENDAR_INFO[calendar];
 ...
 */
function formatYearWithEra(calendar, year) {
